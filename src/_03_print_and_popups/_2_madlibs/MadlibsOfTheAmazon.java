...
public class MadlibsOfTheAmazon {
	...
	public static void main(String[] args) {
		...
		String liquid = JOptionPane.showInputDialog("GIVE ME A LIQUID!!! NOW!!!");
		// Get the player to enter a body part
		String bodypart = JOptionPane.showInputDialog("GIVE ME A BODY PART!!!");
		// Get the player to enter a verb
		String verb = JOptionPane.showInputDialog("GIVE ME A VERB! QUICKLY");
		// Get the player to enter a place
		String place = JOptionPane.showInputDialog("GIVE ME A PLACE!!! ANYWHERE!!!");
